  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Data Strategy Professionals provides expertly crafted test prep materials for DAMA's Certified Data Management Professional (CDMP) exam as well as other trainings in the Data Strategy and Data Science fields."
        />
      ...
      <div className="home-layout">
        ...
        <p style={{ textAlign: "center", fontSize: "1.2em" }}>
          <strong>CDMP Fundamentals Exam Prep</strong>
        </p>
        {/* </Divider> */}
        ...
        {/* <Divider sx={{ fontWeight: 600, fontSize: "1.1em" }}> */}
        <p style={{ textAlign: "center", fontSize: "1.2em" }}>
          <strong>CDMP Specialist Exam Prep</strong>
        </p>
        {/* </Divider> */}
        <div id="product-catalog">
          {products.map((productObj) => {
