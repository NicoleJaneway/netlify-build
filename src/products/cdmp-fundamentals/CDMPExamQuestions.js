        ...
        <div className="teal-box" style={{ gridColumn: "1/-1" }}>
          <div className="center-text-box" id="more-quotes">
            ...
            <p className="float-left">
              ...
              wrong answers. By contrast, the Data Strategy Professionals
              questions and answers are accurate and relevant."
            </p>{" "}
            ...
            <br />
            <p>
              "I was looking for something beyond the CDMP questions provided by
              DAMA to prepare for the exam. I knew I had the experience, but I
              didn't want to retake. The prep questions on Udemy are basically
              useless.
            </p>
            <br />
            <p>
              "The purpose of the Data Strategy Professionals{" "}
              <strong>Question Sets</strong> and{" "}
              <Link to="/products/cdmp-fundamentals-notes">Notes</Link> is
              really to help someone. Your heart was really in the right place
              when creating this. Thank you for helping out the community in the
              right way.
            </p>
            <br />
            <p>
              "Data Strategy Professionals offers preparation in a very
              practical, in a very straightforward way, cutting out all the
              noise to get people ready for a proper career in this area."
            </p>
            <p style={{ textAlign: "right" }}>- Marc Knuttel,</p>
            <p style={{ textAlign: "right", marginBottom: "30px" }}>
              <em>
                member of{" "}
                <a
