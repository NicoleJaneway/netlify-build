...
export default function CDMPStudyPlan() {
  const [value, setValue] = useState("90-day plan");
  ...
  function handleSubmit(event) {
    ...
    if (value === "90-day plan") {
      window.open(
        "https://www.paypal.com/instantcommerce/checkout/3THWB36MLAXCU",
        "_blank"
      );
    } else if (value === "immediate access") {
      window.open("https://py.pl/RYRDg", "_blank");
    }
  }
  ...
  return (
    <>
      {showProductsPopup && (
        <dialog className="products-popup box-shadow" style={{ width: "90%" }}>
      ...
      <div className="product-layout">
              ...
              <form onSubmit={handleSubmit}>
                <label htmlFor="options">
                  ...
                  <select
                    ...
                    style={{ width: "100%" }}
                  >
                    <option value="90-day plan">90-Day Study Plan</option>
        ...
        <div className="teal-box">
          <div className="center-text-box" id="more-quotes">
            ...
            <br />
            <p>
              "I recommend Nicole's study guide. The price is very reasonable,
