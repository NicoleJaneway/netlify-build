...
export default function BIDSEmailBootcamp() {
  const [value, setValue] = useState("breaking-12-weeks");
  ...
  function handleSubmit(event) {
    ...
    if (value === "breaking-12-weeks") {
      window.open("https://buy.stripe.com/aEU2b56906JRffy5kY", "_blank");
    } else if (value === "breaking-immediate-access") {
              ...
              <form onSubmit={handleSubmit}>
                <label htmlFor="options">
                  ...
                  <select
                    ...
                    style={{ width: "100%" }}
                  >
                    <option value="breaking-12-weeks">
                      12 Week Email Bootcamp
                    </option>
                    <option value="breaking-immediate-access">
                      Immediate Access
                    </option>
                  </select>
                </label>{" "}
        ...
        <div className="white-outline-box">
          <div className="center-text-box" id="more-quotes">
            <p className="box-title">
              <strong>Want to Check it out First?</strong>
            </p>
            <div className="product-info sevenths">
              <div style={{ gridColumn: "1 / -2" }}>
                <p>
                  Get the <strong>first seven days</strong> of the Breaking into
                  Data Science Email Bootcamp delivered straight to your inbox
                  for free. In seven days, you'll learn:
                </p>
                <div className="two-col">
                  <ul>
                    <li>The responsibilities of a Data Scientist</li>
                    <li>
                      The mathematical concepts you need to be familiar with
                    </li>
                    ...
                    <li>
                      ...
                      <Link to="/resources/foundations">Data Strategy</Link>
                    </li>
                ...
                <br />
                <p>
                  This is a great way to <strong>experience the course</strong>{" "}
              ...
              >
                <Link to={`/products/breaking-free-trial/checkout`}>
                  <button
                    className="btn btn-accent"
                    style={{
                      width: "300px",
